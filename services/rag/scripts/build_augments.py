...
from deckguru_rag.processing import build_lolchess_augments_jsonl  # noqa: E402


def main() -> None:
    raw_dir = REPO_ROOT / "data" / "rag" / "raw" / "lolchess"
    output_dir = REPO_ROOT / "data" / "rag" / "processed" / "augments"
    output_path = build_lolchess_augments_jsonl(
        raw_dir,
        output_dir,
