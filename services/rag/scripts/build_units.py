...
from deckguru_rag.processing import build_lolchess_units_jsonl  # noqa: E402


def main() -> None:
    raw_dir = REPO_ROOT / "data" / "rag" / "raw" / "lolchess"
    output_dir = REPO_ROOT / "data" / "rag" / "processed" / "units"
    patch_version = _current_patch()
    output_path = build_lolchess_units_jsonl(raw_dir, output_dir, patch_version=patch_version)
